...
command="bcftools view -O z --threads 8 -o ${directory}/split_by_chr.{}.vcf.gz $input_vcf {} || exit 1; python $SCRIPT_LOCATION/split_vcf.py -i ${directory}/split_by_chr.{}.vcf.gz -s $chunk_size -o $vep_chunk_file || exit 1; rm ${directory}/split_by_chr.{}.vcf.gz"
